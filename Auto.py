...
for i in range(1, 30):
    url = "https://aarthiknews.com/category/Auto/?page=" + str(i)
...
csv_file_path = "./MajorProject/News_Headline_Trade_Auto.csv"
...
df.to_csv("./MajorProject/News_Headline_Trade_Auto.csv", encoding='utf-8-sig', index_label="Index")