...
for i in range(1, 60):
    url = "https://aarthiknews.com/category/Non-life%20Insurance/?page=" + str(i)
...
csv_file_path = "./MajorProject/News_Headline_Insurance_NonLife.csv"
...
df.to_csv("./MajorProject/News_Headline_Insurance_NonLife.csv", encoding='utf-8-sig', index_label="Index")