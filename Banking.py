...
# Triggering all 413 pages
for i in range(1, 413):
    url = "https://aarthiknews.com/category/banking/?page=" + str(i)
...
csv_file_path = "./MajorProject/News_Headline_Banking.csv"
...
df.to_csv("./MajorProject/News_Headline_Banking.csv", encoding='utf-8-sig', index_label="Index")