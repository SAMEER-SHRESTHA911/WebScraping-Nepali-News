...
for i in range(1, 30):
    url = "https://aarthiknews.com/category/IPO/?page=" + str(i)
...
csv_file_path = "./MajorProject/News_Headline_ShareMarket_Ipo.csv"
...
df.to_csv("./MajorProject/News_Headline_ShareMarket_Ipo.csv", encoding='utf-8-sig', index_label="Index")