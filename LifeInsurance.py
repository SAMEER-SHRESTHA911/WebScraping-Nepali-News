...
csv_file_path = "./MajorProject/News_Headline_Insurance_LifeInsurance.csv"
...
df.to_csv("./MajorProject/News_Headline_Insurance_LifeInsurance.csv", encoding='utf-8-sig', index_label="Index")