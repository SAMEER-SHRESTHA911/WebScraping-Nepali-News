...
for i in range(1, 30):
    url = "https://aarthiknews.com/category/Divident/?page=" + str(i)
...
csv_file_path = "./MajorProject/News_Headline_ShareMarket_Divident.csv"
...
df.to_csv("./MajorProject/News_Headline_ShareMarket_Divident.csv", encoding='utf-8-sig', index_label="Index")